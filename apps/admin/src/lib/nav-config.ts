...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Planes", href: "/planes", icon: ClipboardList, permission: "catalogo.leer", implemented: false },
  { label: "Proveedores", href: "/proveedores", icon: Truck, permission: "catalogo.leer", implemented: false },
